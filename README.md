...
* Format Specifiers (`%d`, `%u`, `%o`, `%x`, `%f`, `%c`, `%s`, etc.)[span_8](start_span)[span_8](end_span)
* Input/Output Functions (`printf`, `scanf`, `getchar`, `putchar`, `fgets`, `puts`)[span_9](start_span)[span_9](end_span)
* Escape Sequences (`\n`, `\t`, `\\`, `\"`, `\r`)[span_10](start_span)[span_10](end_span)
* Precision formatting for floating-point numbers[span_11](start_span)[span_11](end_span)
...
## Task List
- [x] Task 1: GitHub Repository & README Setup[span_12](start_span)[span_12](end_span)
- [x] Task 2: Branch, Commit & Pull Request
